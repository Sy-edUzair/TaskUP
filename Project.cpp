...
public:
    ...
    {
        cout << "\t\t\t\t\t\t\t" << TaskIndex + 1 << setw(15) << IncompleteTask[TaskIndex]->TaskID << setw(30) << IncompleteTask[TaskIndex]->TaskName << setw(15) << IncompleteTask[TaskIndex]->deadline << setw(15) << IncompleteTask[TaskIndex]->TaskPriority << setw(15) << IncompleteTask[TaskIndex]->category << setw(15);
    ...
    void displayHeading()
    {
        // cout << "\t\t\t\t\t\t\t"<< "TaskIndex" << setw(10) << "TaskID" << setw(20) << "Name" << setw(20) << "Deadline" << setw(15) << "Category" << setw(13) << "Status" << endl;
        cout << "\t\t\t\t\t\t\t"
             << "TaskIndex" << setw(10) << "TaskID" << setw(20) << "Name" << setw(25) << "Deadline" << setw(15) << "Priority" << setw(13) << "Category" << setw(13) << "Status" << endl;
    }
    ...
    void DisplayCompletedTask()
    {
        ...
        {
            cout << "\t\t\t\t\t\t\t" << TaskIndex + 1 << setw(15) << CompletedTask[TaskIndex]->TaskID << setw(30) << CompletedTask[TaskIndex]->TaskName << setw(15) << CompletedTask[TaskIndex]->deadline << setw(15) << CompletedTask[TaskIndex]->TaskPriority << setw(15) << IncompleteTask[TaskIndex]->category << setw(15);
